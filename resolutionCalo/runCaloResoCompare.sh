if [ $1 == "run" ] ; then
  ...
  #inputfile=/media/nschmidt/local/AnalysisSoftwareEIC/resolutionCalo/ECal_inputs.txt
    echo -e "/media/nschmidt/local/AnalysisSoftwareEIC/resolutionCalo/plotsResolutionEEMC-wMatFitting/ResolutionPostProcessing.root EEMC EEMC 0\n/media/nschmidt/local/AnalysisSoftwareEIC/resolutionCalo/plotsResolutionBECAL-wMatFitting/ResolutionPostProcessing.root BECAL BEMC 1\n/media/nschmidt/local/AnalysisSoftwareEIC/resolutionCalo/plotsResolutionFEMC-wMatFitting/ResolutionPostProcessing.root FEMC FEMC 2" > ECal_inputs.txt
...
#fi
  ...
  #inputfile=/media/nschmidt/local/AnalysisSoftwareEIC/resolutionCalo/HCal_inputs.txt
    echo -e "/media/nschmidt/local/AnalysisSoftwareEIC/resolutionCalo/plotsResolutionCHCALFitting/ResolutionPostProcessing.root HCALOUT OHCAL 1\n/media/nschmidt/local/AnalysisSoftwareEIC/resolutionCalo/plotsResolutionLFHCALFitting/ResolutionPostProcessing.root LFHCAL LFHCAL 2" > HCal_inputs.txt
