...
#   inputfile=/home/fbock/EIC/Analysis/CaloNIM/treeAnalysis/treeProcessing/EEMCUpdate_BCNG_ZeroField/output_CRH.root
#   root -b -x -l -q 'energyResolutionCalorimeters.C("'$inputfile'","FEMC-wMat","MA","'$suffix'",kTRUE)'
#   root -b -x -l -q 'energyResolutionCalorimeters.C("'$inputfile'","BECAL-wMat","MA","'$suffix'",kTRUE)'
#   root -b -x -l -q 'energyResolutionCalorimeters.C("'$inputfile'","EEMC-wMat","MA","'$suffix'",kTRUE)'

#   inputfile=/home/fbock/EIC/Analysis/CaloNIM/treeAnalysis/treeProcessing/SingleElectronECCEdefault_FixedE/output_CRH.root
#   inputfile=/home/fbock/EIC/Analysis/CaloNIM/treeAnalysis/treeProcessing/SingleElectronWOMat_FixedE/output_CRH.root
  inputfile=/home/fbock/EIC/Analysis/CaloNIM/treeAnalysis/treeProcessing/SingleElectronWOTTL_FixedE/output_CRH.root
  root -b -x -l -q 'energyResolutionCalorimeters.C("'$inputfile'","FEMC-wMat","MA","'$suffix'",kTRUE)'
  root -b -x -l -q 'energyResolutionCalorimeters.C("'$inputfile'","BECAL-wMat","MA","'$suffix'",kTRUE)'
  root -b -x -l -q 'energyResolutionCalorimeters.C("'$inputfile'","EEMC-wMat","MA","'$suffix'",kTRUE)'


#   inputfile=/home/fbock/EIC/Analysis/CaloNIM/treeAnalysis/treeProcessing/EEMCUpdate_BCNG_TTLGEO_8_Pythia6MB/output_CRH.root
#   root -b -x -l -q 'energyResolutionCalorimeters.C("'$inputfile'","EEMC-wMat","MA","'$suffix'",kTRUE)'
...
#   root -b -x -q -l 'positionResolutionCalorimeters.C("'$inputfile'","BECAL-wMat","MA","pdf",kFALSE)'
  ...
  inputfile=/home/fbock/EIC/Analysis/CaloNIM/treeAnalysis/treeProcessing/ZeroField-ElectronTest/output_CRH.root
  root -b -x -q -l 'positionResolutionCalorimeters.C("'$inputfile'","EEMC-wMat","MA","pdf",kFALSE)'
  root -b -x -q -l 'positionResolutionCalorimeters.C("'$inputfile'","FEMC-wMat","MA","pdf",kFALSE)'
  root -b -x -q -l 'positionResolutionCalorimeters.C("'$inputfile'","BECAL-wMat","MA","pdf",kFALSE)'
  
  inputfile=/home/fbock/EIC/Analysis/CaloNIM/treeAnalysis/treeProcessing/ZeroField-PionsTest/output_CRH.root
  root -b -x -q -l 'positionResolutionCalorimeters.C("'$inputfile'","LFHCAL-wMat","MA","pdf",kFALSE)'
  root -b -x -q -l 'positionResolutionCalorimeters.C("'$inputfile'","EHCAL-wMat","MA","pdf",kFALSE)'
  root -b -x -q -l 'positionResolutionCalorimeters.C("'$inputfile'","CHCAL-wMat","MA","pdf",kFALSE)'
...
#   root -b -x -q -l 'positionResolutionCalorimeters.C("'$inputfile'","BECAL-wMat","MA","pdf",kFALSE)'
  ...
  root -b -x -l -q 'compare_EnergyResol.C("compareMaterialBEMC.txt","MaterialStudies","BECAL","pdf",1)'
  root -b -x -l -q 'compare_EnergyResol.C("compareMaterialBEMC.txt","MaterialStudies","BECAL","pdf",3)'
  root -b -x -l -q 'compare_EnergyResol.C("compareMaterialBEMC.txt","MaterialStudies","BECAL","pdf",9)'
  root -b -x -l -q 'compare_EnergyResol.C("compareMaterialBEMC.txt","MaterialStudies","BECAL","pdf",23)'
  root -b -x -l -q 'compare_EnergyResol.C("compareMaterialBEMC.txt","MaterialStudies","BECAL","pdf",20)'
  ...
  root -b -x -l -q 'compare_EnergyResol.C("compareMaterialEEMC.txt","MaterialStudies","EEMC","pdf",9)'
  root -b -x -l -q 'compare_EnergyResol.C("compareMaterialEEMC.txt","MaterialStudies","EEMC","pdf",23)'
...
#   root -b -x -l -q 'compare_EnergyResol.C("compareMaterialEEMC_0_5mmCarbon.txt","MaterialStudies05mmCarbon","EEMC","pdf",20)'
  ...
  root -b -x -l -q 'compare_EnergyResol.C("compareMaterialFEMC.txt","MaterialStudies","FEMC","pdf",9)'
  root -b -x -l -q 'compare_EnergyResol.C("compareMaterialFEMC.txt","MaterialStudies","FEMC","pdf",23)'
