...
void resolutionhistos(){
  ...
  for(int icalo=0;icalo<_active_calo;icalo++){
    for(int ialgo=0;ialgo<_active_algo;ialgo++){
      ...
      for(Int_t iclus=0; iclus<nclusters_RH; iclus++){
        ...
        h_RH_Reso_E[icalo][ialgo]->Fill(_mcpart_E[clusters_RH_trueID[iclus]],clusters_RH_E[iclus]/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==22)h_RH_Reso_gamma_E[icalo][ialgo]->Fill(_mcpart_E[clusters_RH_trueID[iclus]],clusters_RH_E[iclus]/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==211)h_RH_Reso_pion_E[icalo][ialgo]->Fill(_mcpart_E[clusters_RH_trueID[iclus]],clusters_RH_E[iclus]/_mcpart_E[clusters_RH_trueID[iclus]]);

        float smearedClusE = clusters_RH_E[iclus]*=getEnergySmearing(icalo,ialgo);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==211)h_RH_Reso_pion_smear_E[icalo][ialgo]->Fill(_mcpart_E[clusters_RH_trueID[iclus]],smearedClusE/_mcpart_E[clusters_RH_trueID[iclus]]);

        Int_t et = 0;
        while ( ( clusters_RH_Eta[iclus] > partEta[et+1] ) && ( et < nEta )) et++;
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==22)h_RH_Reso_gamma_E_Eta[icalo][ialgo][et]->Fill(_mcpart_E[clusters_RH_trueID[iclus]],clusters_RH_E[iclus]/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==211)h_RH_Reso_pion_E_Eta[icalo][ialgo][et]->Fill(_mcpart_E[clusters_RH_trueID[iclus]],clusters_RH_E[iclus]/_mcpart_E[clusters_RH_trueID[iclus]]);

        h_RH_Reso_Erec[icalo][ialgo]->Fill(clusters_RH_E[iclus],clusters_RH_E[iclus]/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==22)h_RH_Reso_gamma_Erec[icalo][ialgo]->Fill(clusters_RH_E[iclus],clusters_RH_E[iclus]/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==211)h_RH_Reso_pion_Erec[icalo][ialgo]->Fill(clusters_RH_E[iclus],clusters_RH_E[iclus]/_mcpart_E[clusters_RH_trueID[iclus]]);


        h_RH_ResoCalib_E[icalo][ialgo]->Fill(_mcpart_E[clusters_RH_trueID[iclus]],clusterE_calo/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==22)h_RH_ResoCalib_gamma_E[icalo][ialgo]->Fill(_mcpart_E[clusters_RH_trueID[iclus]],clusterE_calo/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==211)h_RH_ResoCalib_pion_E[icalo][ialgo]->Fill(_mcpart_E[clusters_RH_trueID[iclus]],clusterE_calo/_mcpart_E[clusters_RH_trueID[iclus]]);


        h_RH_ResoCalib_Erec[icalo][ialgo]->Fill(clusterE_calo,clusterE_calo/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==22)h_RH_ResoCalib_gamma_Erec[icalo][ialgo]->Fill(clusterE_calo,clusterE_calo/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==211)h_RH_ResoCalib_pion_Erec[icalo][ialgo]->Fill(clusterE_calo,clusterE_calo/_mcpart_E[clusters_RH_trueID[iclus]]);
        if(abs(_mcpart_PDG[clusters_RH_trueID[iclus]])==211)h_RH_ResoCalib_smeared_pion_Erec[icalo][ialgo]->Fill(clusterE_calo,(clusterE_calo*getEnergySmearing(icalo,ialgo))/_mcpart_E[clusters_RH_trueID[iclus]]);
      }
    }
  }
  int icalo =0;
  for(int ialgo=0;ialgo<_active_algo;ialgo++){
    ...
    for(Int_t iclus=0; iclus<nclusters_comb_RH; iclus++){
      ...
      // if(verbosityRH>1) cout << "\tfound MC:  particle " << clusters_comb_RH_trueID[iclus] << "\twith E = " << _mcpart_E[clusters_comb_RH_trueID[iclus]] << " GeV" << endl;

      h_RH_ResoComb_E[icalo][ialgo]->Fill(_mcpart_E[clusters_comb_RH_trueID[iclus]],clusterenergy/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      if(abs(_mcpart_PDG[clusters_comb_RH_trueID[iclus]])==22)h_RH_ResoComb_gamma_E[icalo][ialgo]->Fill(_mcpart_E[clusters_comb_RH_trueID[iclus]],clusterenergy/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      if(abs(_mcpart_PDG[clusters_comb_RH_trueID[iclus]])==211)h_RH_ResoComb_pion_E[icalo][ialgo]->Fill(_mcpart_E[clusters_comb_RH_trueID[iclus]],clusterenergy/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      h_RH_ResoCombCalib_E[icalo][ialgo]->Fill(_mcpart_E[clusters_comb_RH_trueID[iclus]],clusterenergyCalib/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      if(abs(_mcpart_PDG[clusters_comb_RH_trueID[iclus]])==22)h_RH_ResoCombCalib_gamma_E[icalo][ialgo]->Fill(_mcpart_E[clusters_comb_RH_trueID[iclus]],clusterenergyCalib/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      if(abs(_mcpart_PDG[clusters_comb_RH_trueID[iclus]])==211)h_RH_ResoCombCalib_pion_E[icalo][ialgo]->Fill(_mcpart_E[clusters_comb_RH_trueID[iclus]],clusterenergyCalib/_mcpart_E[clusters_comb_RH_trueID[iclus]]);

      h_RH_ResoComb_Erec[icalo][ialgo]->Fill(clusterenergy,clusterenergy/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      if(abs(_mcpart_PDG[clusters_comb_RH_trueID[iclus]])==22)h_RH_ResoComb_gamma_Erec[icalo][ialgo]->Fill(clusterenergy,clusterenergy/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      if(abs(_mcpart_PDG[clusters_comb_RH_trueID[iclus]])==211)h_RH_ResoComb_pion_Erec[icalo][ialgo]->Fill(clusterenergy,clusterenergy/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      h_RH_ResoCombCalib_Erec[icalo][ialgo]->Fill(clusterenergy,clusterenergyCalib/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      h_RH_ResoCombCalib_smeared_Erec[icalo][ialgo]->Fill(clusterenergy,clusterengeryCalib_smeared/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      if(abs(_mcpart_PDG[clusters_comb_RH_trueID[iclus]])==22)h_RH_ResoCombCalib_gamma_Erec[icalo][ialgo]->Fill(clusterenergy,clusterenergyCalib/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
      if(abs(_mcpart_PDG[clusters_comb_RH_trueID[iclus]])==211)h_RH_ResoCombCalib_pion_Erec[icalo][ialgo]->Fill(clusterenergy,clusterenergyCalib/_mcpart_E[clusters_comb_RH_trueID[iclus]]);
    }
  }
}
