...
if [ $1 = "DRCALO_ECCE" ]; then
    maxevt=-1
    input=/media/nschmidt/SSD/simulationOutputCADES/tst/ECCEGEOM_DRCALO_HITS_SimplePionfwd.root
    geometry=/media/nschmidt/SSD/simulationOutputCADES/tst/geometry_ECCEGEOM_DRCALO.root
    root -x -l -b -q 'treeProcessing.C+("'$input'","'$geometry'","ECCEGEOM_DRCALO",'$maxevt',true,false  ,true,0)'
fi
...
maxevt=-1
    ...
    input=/media/nschmidt/SSD/simulationOutputCADES/tst/ECCEGEOM_HITS_SimplePiZero.root
    ...
    geometry=/media/nschmidt/SSD/simulationOutputCADES/tst/geometry_ECCEGEOM.root
    #geometry="/media/nschmidt/local/EIC_running/ECCE/ECCE_TTLGEO_7_add_HITS_pi0_SimplePiZero/geometry.root"
    #input="/Users/ins/Downloads/singleElec_merged/DST_General_particleGun_singleElectron_merged_eval.root"
    #geometry="/Users/ins/Downloads/singleElec_merged/geometry2ndCampaign.root"
    root -x -l -b -q 'treeProcessing.C+("'$input'","'$geometry'","PI0SIM_ECCEGEOM",'$maxevt',true,false  ,true,0)'
fi
