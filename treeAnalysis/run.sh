...
file3TLBLLGADpTHard2x=/home/fbock/eic/simulationOutput/Modular/output_ALLSILICON-FTTLS3LC-ETTL-CTTL-TREXTOUT-HC2xEC2x_e10p250pTHard5/G4EICDetector_eventtree.root
...
root -x -l -b -q 'treeProcessing.C("'$fileLBLLGAD5100pTHard'","LBLLGAD_e5p100_pTHard",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
root -x -l -b -q 'treeProcessing.C("'$fileLBLLGAD18275MB'","LBLLGAD_e18p275_MB",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
root -x -l -b -q 'treeProcessing.C("'$fileLBLLGAD18275pTHard'","LBLLGAD_e18p275_pTHard",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'

# LBL AC-LGAD 3T
root -x -l -b -q 'treeProcessing.C("'$file3TLBLACLGADpTHard'","LBLACLGAD_3T_pTHard",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
root -x -l -b -q 'treeProcessing.C("'$file3TLBLACLGADMB'","LBLACLGAD_3T_MB",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
# LBL 3T
root -x -l -b -q 'treeProcessing.C("'$file3TLBLpTHard'","LBL_3T_pTHard",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
root -x -l -b -q 'treeProcessing.C("'$file3TLBLMB'","LBL_3T_MB",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
LBL LGAD 3T
root -x -l -b -q 'treeProcessing.C("'$file3TLBLLGADMB'","LBLLGAD_3T_MB",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
root -x -l -b -q 'treeProcessing.C("'$file3TLBLLGADpTHard'","LBLLGAD_3T_pTHard",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
# LBL LGAD double granul 3T
root -x -l -b -q 'treeProcessing.C("'$file3TLBLLGADpTHard2x'","LBLLGAD2x_3T_pTHard",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'

# LBL LGAD 3T other cms energies
root -x -l -b -q 'treeProcessing.C("'$file3TLBLLGAD5100MB'","LBLLGAD_3T_e5p100_MB",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
root -x -l -b -q 'treeProcessing.C("'$file3TLBLLGAD5100pTHard'","LBLLGAD_3T_e5p100_pTHard",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
root -x -l -b -q 'treeProcessing.C("'$file3TLBLLGAD18275MB'","LBLLGAD_3T_e18p275_MB",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
root -x -l -b -q 'treeProcessing.C("'$file3TLBLLGAD18275pTHard'","LBLLGAD_3T_e18p275_pTHard",true,true,true,true,true,true,true,true,true,true,true,true,false,-1,0)'
