...
if [ $1 = "fbock" ]; then
  input_elec=/home/fbock/EIC/Analysis/2ndSimulationCampaign/treeAnalysis/treeProcessing/SingleParticleEEMCPCarbonEOP/output_EOPSTUD.root
  input_pion=/home/fbock/EIC/Analysis/2ndSimulationCampaign/treeAnalysis/treeProcessing/SingleParticleEEMCPCarbonEOP/output_EOPSTUD.root
fi
