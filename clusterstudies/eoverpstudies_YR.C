...
void eoverpstudies_YR(
  ...
  TString matchbasis = "projectionbased";
  for(int icalo=0;icalo<maxcalo;icalo++){
    cout << "processing " << caloName[icalo].Data() << endl;
    TString NameEP_hist_EpE = Form("%s/h_TMstudies_EoverP_pions_EoverP_E_%s_%s",caloName[icalo].Data(),matchbasis.Data(), caloName[icalo].Data() );
    // TString NameE_Minv = Form("%s/h_Etrue_Minv_%s_%s",caloName[icalo].Data(), caloName[icalo].Data(), clusterizerName.Data() );
    h_TMstudies_EoverP_pions_EoverP_E[icalo]    = (TH2F*)inputFilePion->Get(NameEP_hist_EpE.Data());
    ...
    h_TMstudies_EoverP_electrons_EoverP_E[icalo]    = (TH2F*)inputFileElec->Get(Form("%s/h_TMstudies_EoverP_electrons_EoverP_E_%s_%s",caloName[icalo].Data(), matchbasis.Data(), caloName[icalo].Data() ));
    h_TMstudies_EoverP_trackSpec_pions[icalo]    = (TH1F*)inputFilePion->Get(Form("%s/h_TMstudies_EoverP_trackSpec_pions_%s",caloName[icalo].Data(), caloName[icalo].Data() ));
    h_TMstudies_EoverP_trackSpec_electrons[icalo]    = (TH1F*)inputFileElec->Get(Form("%s/h_TMstudies_EoverP_trackSpec_electrons_%s",caloName[icalo].Data(), caloName[icalo].Data() ));
  ...
  // TH1F* histEoP_proj_electrons[maxcalo][50] = {{NULL}};
    ...
    for(int ebin=0;ebin<nEne-1;ebin++){
      ...
      // if(histEoP_proj_pions[icalo][padebin]->GetEntries() > 10){
        Double_t intpions  = histEoP_proj_pions[icalo][padebin]->Integral(histEoP_proj_pions[icalo][padebin]->GetXaxis()->FindBin(eopcutvalue[icalo]), histEoP_proj_pions[icalo][padebin]->GetXaxis()->FindBin(eopcutvaluemax[icalo]));
        ...
        Double_t intpionsall  = histEoP_proj_pions[icalo][padebin]->Integral(histEoP_proj_pions[icalo][padebin]->GetXaxis()->FindBin(0.0), histEoP_proj_pions[icalo][padebin]->GetXaxis()->FindBin(1.9));
      ...
      // if(histEoP_proj_electrons[icalo][padebinelec]->GetEntries() > 10){
        Double_t intelectrons  = histEoP_proj_electrons[icalo][padebinelec]->Integral(histEoP_proj_electrons[icalo][padebinelec]->GetXaxis()->FindBin(eopcutvalue[icalo]), histEoP_proj_electrons[icalo][padebinelec]->GetXaxis()->FindBin(eopcutvaluemax[icalo]));
        ...
        Double_t intelectronsall  = histEoP_proj_electrons[icalo][padebinelec]->Integral(histEoP_proj_electrons[icalo][padebinelec]->GetXaxis()->FindBin(0.0), histEoP_proj_electrons[icalo][padebinelec]->GetXaxis()->FindBin(1.9));
      ...
      double rejection = histIntCounts_pions_all[icalo]->GetBinContent(histIntCounts_pions_all[icalo]->GetXaxis()->FindBin((partE[ebin]+partE[ebin+1])/2)) / histIntCounts_pions_EoP[icalo]->GetBinContent(histIntCounts_pions_EoP[icalo]->GetXaxis()->FindBin((partE[ebin]+partE[ebin+1])/2));
    ...
    for(int z=0; z< padebin +1 ; z++ ){
      if(z==4){
        ...
        //   fithistEtrueMinvFINAL[icalo][padnumber]->SetLineWidth(1);
        //   fithistEtrueMinvFINAL[icalo][padnumber]->Draw("same");
          DrawGammaLines(eopcutvalue[icalo], eopcutvalue[icalo], 0, 0.5*histEoP_proj_electrons[icalo][padnumber]->GetMaximum(),1, kGray+1,3);
          DrawGammaLines(eopcutvaluemax[icalo], eopcutvaluemax[icalo], 0, 0.5*histEoP_proj_electrons[icalo][padnumber]->GetMaximum(),1, kGray+1,3);
        //   DrawGammaLines(allmean[icalo][padnumber] - allsigma[icalo][padnumber], allmean[icalo][padnumber]- allsigma[icalo][padnumber], 0, fithistEtrueMinvFINAL[icalo][padnumber]->GetMaximum(), 1, 12);
        //   if(z==0){
        //     legend1->AddEntry(histEoP_proj_pions[icalo][padnumber], "Simulation", "p");
        //     legend1->AddEntry(fithistEtrueMinvFINAL[icalo][padnumber], "Fit", "l");
    ...
    for(int z=0; z< padebin +1 ; z++ ){
      if(z==4){
        ...
        if(!histEoP_proj_pions[icalo][padnumber]){ cout << "lol" << endl;padnumber++; continue;}
        //Form("%0.1d GeV < E <  %0.1d GeV",2*z, 2*z+2)
        SetStyleHistoTH1ForGraphs( histEoP_proj_pions[icalo][padnumber], "#it{p}_{track}", "counts", 1.5*textSizeSinglePad,1.5*textSizeSinglePad, 1.7*textSizeSinglePad,2*textSizeSinglePad,0.6,1.1);
        DrawGammaSetMarker(histEoP_proj_pions[icalo][padnumber],34,1, kRed+2, kRed+2);
        histEoP_proj_pions[icalo][padnumber]->GetYaxis()->SetNdivisions(5);
        histEoP_proj_pions[icalo][padnumber]->GetXaxis()->SetNdivisions(5);
        histEoP_proj_pions[icalo][padnumber]->GetXaxis()->SetRangeUser(0,2.0);
        histEoP_proj_pions[icalo][padnumber]->Draw("ep");
          DrawGammaLines(eopcutvalue[icalo], eopcutvalue[icalo], 0, 0.5*histEoP_proj_pions[icalo][padnumber]->GetMaximum(),1, kGray+1,3);
          DrawGammaLines(eopcutvaluemax[icalo], eopcutvaluemax[icalo], 0, 0.5*histEoP_proj_pions[icalo][padnumber]->GetMaximum(),1, kGray+1,3);
        //   DrawGammaLines(allmean[icalo][padnumber] - allsigma[icalo][padnumber], allmean[icalo][padnumber]- allsigma[icalo][padnumber], 0, fithistEtrueMinvFINAL[icalo][padnumber]->GetMaximum(), 1, 12);
          if(z==0){
    ...
    mass2D->Print(Form("%s/EoP_bin_pions_%s_%s.%s", outputDir.Data(), caloName[icalo].Data(), clusterizerName.Data(), suffix.Data()));
