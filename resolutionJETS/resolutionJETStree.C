...
void resolutionJETStree(
  ...
  TString str_jet_type_plot[njettypes] = {"Charged Jets (Track)", "Calo Jets (FHCAL+FEMC)" , "PF Jets (Track+Calo)"};
  ...
  DrawGammaLines(0, 109, 0., 0., 1, kGray+2, 7);
    DrawGammaSetMarker(histo_JES_E[1][0][selectedeta], marker_jets[0], 2, color_jets[0], color_jets[0]);
    histo_JES_E[1][0][selectedeta]->Draw("same,p");
    legendJES_E->AddEntry(histo_JES_E[1][0][selectedeta],"ALL-SI, BABAR (#it{B}=1.5T)","pl");

    DrawGammaSetMarker(histo_JES_E[3][0][selectedeta], 25, 2, kRed+2, kRed+2);
    ...
    DrawGammaSetMarker(histo_JES_E[2][0][selectedeta], 24, 2, kBlue+2, kBlue+2);
  ...
  histJESPlotDummy_E                           = new TH2F("histJESPlotDummy_E","histJESPlotDummy_E",1000,0, 109,1000,-0.59, 0.89);
  SetStyleHistoTH2ForGraphs(histJESPlotDummy_E, "#it{E}^{jet}","(#it{E}^{rec} - #it{E}^{true}) / #it{E}^{true}", 0.85*textSizeSinglePad,textSizeSinglePad, 0.85*textSizeSinglePad,textSizeSinglePad, 0.9,0.91);
  histJESPlotDummy_E->GetXaxis()->SetNoExponent();
  histJESPlotDummy_E->GetYaxis()->SetNdivisions(505,true);
  histJESPlotDummy_E->GetXaxis()->SetMoreLogLabels(true);
  ...
  legend_JER_Bfield           = GetAndSetLegend2(0.2, 0.15, 0.8, 0.15+(4*textSizeLabelsRel),textSizeLabelsPixel, 1, "", 43, 0.15);
    DrawGammaSetMarker(histo_JER_E[1][0][selectedeta], marker_jets[0], 2, color_jets[0], color_jets[0]);
    histo_JER_E[1][0][selectedeta]->Draw("same,p");
    legend_JER_Bfield->AddEntry(histo_JER_E[1][0][selectedeta],"ALL-SI, BABAR (#it{B}=1.5T)","pl");

    DrawGammaSetMarker(histo_JER_E[3][0][selectedeta], 25, 2, kRed+2, kRed+2);
    histo_JER_E[3][0][selectedeta]->Draw("same,p");
    legend_JER_Bfield->AddEntry(histo_JER_E[3][0][selectedeta],"ALL-SI, BEAST (#it{B}=3.0T)","pl");

    DrawGammaSetMarker(histo_JER_E[0][0][selectedeta], marker_jets[1], 2, color_jets[1], color_jets[1]);
    ...
    DrawGammaSetMarker(histo_JER_E[2][0][selectedeta], 24, 2, kBlue+2, kBlue+2);
  ...
  if(histo_JER_E[1][0][selectedeta] && histo_JER_E[1][0][selectedeta]){
    histEPlotDummy->DrawCopy();
    TLegend* legend_JER_Bfield           = GetAndSetLegend2(0.2, 0.15, 0.8, 0.15+(5*textSizeLabelsRel),textSizeLabelsPixel, 1, "", 43, 0.15);
    ...
    legend_JER_Bfield           = GetAndSetLegend2(0.2, 0.15, 0.8, 0.15+(4*textSizeLabelsRel),textSizeLabelsPixel, 1, "", 43, 0.15);
      ...
      DrawGammaSetMarker(histo_JER_E[0][0][selectedeta], marker_jets[1], 2, color_jets[1], color_jets[1]);
      histo_JER_E[0][0][selectedeta]->Draw("same,p");
      legend_JER_Bfield->AddEntry(histo_JER_E[0][0][selectedeta],"ALL-SI+TTL","pl");

      DrawGammaSetMarker(histo_JER_E[4][0][selectedeta], 24, 2, kBlue+2, kBlue+2);
      histo_JER_E[4][0][selectedeta]->Draw("same,p");
      legend_JER_Bfield->AddEntry(histo_JER_E[4][0][selectedeta],"ALL-SI+TTL, 2x CALO granularity","pl");
